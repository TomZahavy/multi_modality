...
if __name__ == '__main__':
    ...
    X = Math.loadtxt("/Users/tzahavy/Downloads/tsne_python/mnist2500_X.txt");
    labels = Math.loadtxt("/Users/tzahavy/Downloads/tsne_python/mnist2500_labels.txt");

    Y = Math.zeros(shape=(X.shape[0],2))
    for i,result in enumerate(bh_tsne(X, no_dims=2, perplexity=50, theta=0.5)):
        Y[i,:]=result
